...
public class BossController : MonoBehaviour
{
    ...
    IEnumerator LazerLauncherAttack()
    {
        ...
        // �lk lazer launcher'� i�in fade-in
        ...
        // Fade-in tamamland���nda son halini ayarla
        color1.a = 1;
        sr1.color = color1;
        color2.a = 1;
        sr2.color = color2;
